 ...
 *
 *  Licensing notice CljAnt: This file has been copied verbatim from the
 *  file org.apache.tools.ant.Main.java in the ant distribution. The following
 *  minor modifications have been made to this file to support launching
 *  ant from within clojure:
 *
 *  - calls to System.exit(x) have been commented out as we seldom want
 *    to exit the repl in clojure even in exceptional circumstances.
 *  - the buildFile field has been made public
 *  -  
 *
 */
 ...
 *
 */
public class CljAntMain implements AntMain {
    /**
    ...
    public File buildFile; /* null */ //cljant: field made public
    ...
    /**
     * cljant - adding exit code as a field 
     */
    ...
    public static void start(final String[] args, final Properties additionalUserProperties,
        ...
        final CljAntMain m = new CljAntMain();
    ...
    protected void exit(final int exitCode) {
        //System.exit(exitCode); //cljant: commented out
     ...
     */
    @Deprecated
    protected CljAntMain(final String[] args) throws BuildException {
        processArgs(args);
    }
    ...
    private void processArgs(final String[] args) {
        ...
        // CljAnt: conditionally normalize build file
        if (!(buildFile instanceof CljAntBuildFile)) {
            buildFile =
