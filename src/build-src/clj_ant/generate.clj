(ns clj-ant.generate
  ...
  (:import (cljant CljAntProjectHelper CljAntBuildFile)
           (java.io File)
           (java.util Properties)))

(def task-defs-path "org/apache/tools/ant/taskdefs/defaults.properties")
(def type-defs-path "org/apache/tools/ant/typess/defaults.properties")

(def generated-path "target/generated/core_types")
...
(defn generate []
  (reduce
    ...
    ""
    (load-properties type-defs-path))
